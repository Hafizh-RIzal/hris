        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-lg rounded-4 bg-white bg-opacity-75 animate__animated animate__fadeIn">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('departemen.update', $departemen->id) }}" method="POST" class="needs-validation" novalidate>
                        @csrf @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="kode_departemen" class="form-control rounded-3 shadow-sm"
                                   value="{{ old('kode_departemen', $departemen->kode_departemen) }}" maxlength="10" required>
                        </div>

                        <div class="mb-3">
                            <label class="form-label fw-semibold"><i class="fas fa-building me-1"></i> Nama Departemen</label>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="lokasi" class="form-control rounded-3 shadow-sm"
                                   value="{{ old('lokasi', $departemen->lokasi) }}">
                        </div>
