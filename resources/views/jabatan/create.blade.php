                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('jabatan.store') }}" method="POST" class="needs-validation" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="kode_jabatan" class="form-control rounded-3 shadow-sm" value="{{ old('kode_jabatan') }}" maxlength="10" required>
                        </div>

                        <div class="mb-3">
                            <label class="form-label fw-semibold"><i class="fas fa-id-badge me-1"></i>Nama Jabatan</label>
                            <input type="text" name="nama_jabatan" class="form-control rounded-3 shadow-sm" value="{{ old('nama_jabatan') }}" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group shadow-sm">
                                ...
                                <input type="number" name="gaji_pokok" class="form-control rounded-end-3" value="{{ old('gaji_pokok', 0) }}" required>
                            </div>
                        </div>
