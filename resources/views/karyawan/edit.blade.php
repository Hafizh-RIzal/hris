                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nip" class="form-control rounded-3 shadow-sm" value="{{ old('nip', $karyawan->nip) }}" required>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label fw-semibold"><i class="fas fa-user me-1"></i> Nama Lengkap</label>
                                    <input type="text" name="nama_lengkap" class="form-control rounded-3 shadow-sm" value="{{ old('nama_lengkap', $karyawan->nama_lengkap) }}" required>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label fw-semibold"><i class="fas fa-envelope me-1"></i> Email</label>
                                    <input type="email" name="email" class="form-control rounded-3 shadow-sm" value="{{ old('email', $karyawan->email) }}" required>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label fw-semibold"><i class="fas fa-phone me-1"></i> Telepon</label>
                                    <input type="text" name="telepon" class="form-control rounded-3 shadow-sm" value="{{ old('telepon', $karyawan->telepon) }}">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label fw-semibold"><i class="fas fa-id-card-clip me-1"></i> No KTP</label>
                                    <input type="text" name="no_ktp" class="form-control rounded-3 shadow-sm" value="{{ old('no_ktp', $karyawan->no_ktp) }}">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label fw-semibold"><i class="fas fa-file-invoice-dollar me-1"></i> NPWP</label>
                                    <input type="text" name="npwp" class="form-control rounded-3 shadow-sm" value="{{ old('npwp', $karyawan->npwp) }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="tempat_lahir" class="form-control rounded-3 shadow-sm" value="{{ old('tempat_lahir', $karyawan->tempat_lahir) }}">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label fw-semibold"><i class="fas fa-calendar-day me-1"></i> Tanggal Lahir</label>
                                    <input type="date" name="tanggal_lahir" class="form-control rounded-3 shadow-sm" value="{{ old('tanggal_lahir', $karyawan->tanggal_lahir) }}">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label fw-semibold"><i class="fas fa-home me-1"></i> Alamat</label>
                                    <textarea name="alamat" class="form-control rounded-3 shadow-sm" rows="3">{{ old('alamat', $karyawan->alamat) }}</textarea>
                                </div>
                                <div class="mb-3">
